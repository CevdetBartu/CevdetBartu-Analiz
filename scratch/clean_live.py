...
new_hero = """
            <div style={{ padding: "40px 0 20px", textAlign: "center" }}>
              <h1 style={{ fontSize: "2rem", fontWeight: "700", letterSpacing: "-0.5px", color: "var(--foreground)", marginBottom: "8px" }}>Canlı Maçlar</h1>
              <p style={{ color: "var(--muted-foreground)", fontSize: "0.95rem" }}>Şu an oynanan maçların anlık skorlarını ve oranlarını analiz edin.</p>
            </div>
"""

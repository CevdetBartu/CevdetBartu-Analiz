  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ margin: 0, color: "#fff", fontSize: "20px", fontWeight: 800, letterSpacing: "-0.5px", display: "flex", alignItems: "center", gap: "8px" }}>
...
console.log("Widget completely rewritten with correct characters!");
